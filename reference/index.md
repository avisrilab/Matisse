...
## PSI dimensionality reduction and clustering

Reduce the PSI matrix to a low-dimensional embedding and cluster cells
by their splicing profiles — independently of gene expression. The
workflow mirrors Seurat: select variable events, run PCA, project to
UMAP, and find communities with the Louvain algorithm.

- [`FindVariablePSIEvents()`](https://avisrilab.github.io/Matisse/reference/FindVariablePSIEvents.md)
  : Select highly variable PSI events
- [`VariablePSIEvents()`](https://avisrilab.github.io/Matisse/reference/VariablePSIEvents.md)
  : Retrieve variable PSI event IDs
