...
- [`show(`*`<MatisseObject>`*`)`](https://avisrilab.org/Matisse/reference/MatisseObject-class.md)
  [`dim(`*`<MatisseObject>`*`)`](https://avisrilab.org/Matisse/reference/MatisseObject-class.md)
  [`` `[`( ``*`<MatisseObject>`*`,`*`<ANY>`*`,`*`<ANY>`*`,`*`<ANY>`*`)`](https://avisrilab.org/Matisse/reference/MatisseObject-class.md)
  [`` `[[`( ``*`<MatisseObject>`*`,`*`<ANY>`*`,`*`<ANY>`*`)`](https://avisrilab.org/Matisse/reference/MatisseObject-class.md)
...
- [`GetSeurat()`](https://avisrilab.org/Matisse/reference/GetSeurat.md)
  : Get the embedded Seurat object
- [`GetPSI()`](https://avisrilab.org/Matisse/reference/GetPSI.md) : Get
  the PSI matrix
- [`SetPSI()`](https://avisrilab.org/Matisse/reference/SetPSI.md) : Set
  the PSI matrix
...
- [`FindMarkers(`*`<MatisseObject>`*`)`](https://avisrilab.org/Matisse/reference/FindMarkers.MatisseObject.md)
...
- [`AddMetaData(`*`<MatisseObject>`*`)`](https://avisrilab.org/Matisse/reference/AddMetaData.MatisseObject.md)
